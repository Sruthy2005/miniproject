...
<html lang="en">
  <head>
    <title>Bellezza - Makeup Services</title>
    <meta charset="utf-8" />
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Makeup Services</h2>
        ...
        <div class="row">
          ...
          $sql = "SELECT * FROM service WHERE category = 'makeup' ORDER BY name";
            ...
            <div class="col-md-4 ftco-animate">
              <div class="block-7">
                ...
                <div class="text-center p-4">
                  ...
                  <span class="excerpt d-block" style="font-size: 0.9rem;">Professional Makeup Service</span>
                  <span class="price" style="font-size: 1.1rem;">
                    <span class="number"><?php echo htmlspecialchars($service['price']); ?></span>
                  </span>
                  <a href="booking.php?service=makeup&service_id=<?php echo htmlspecialchars($service['id']); ?>" 
          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="#">Latest Makeup Trends</a></h3>
                  <div class="meta">
