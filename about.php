      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-6 d-flex ftco-animate">
            <div
              class="img img-about align-self-stretch"
              style="background-image: url(images/bg_3.jpg); width: 100%"
            ></div>
          </div>
          <div class="col-md-6 pl-md-5 ftco-animate">
            <h2 class="mb-4">Welcome to BELLEZZA Beauty</h2>
            <p>
              BELLEZZA Beauty is a leading beauty salon that offers a wide range
              of beauty and grooming services. Our team of experienced
              professionals is dedicated to providing you with the highest
              quality services and products to help you look and feel your best.
            </p>
            <p>
