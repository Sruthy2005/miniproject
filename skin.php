...
<html lang="en">
  <head>
    <title>Bellezza - Skin Care Services</title>
    <meta charset="utf-8" />
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Skin Care Services</h2>
            <p>Experience professional skin care treatments tailored to your needs</p>
          </div>
        </div>
        <div class="row">
          <?php
          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="#">Skin Care Tips for Healthy Glowing Skin</a></h3>
                  <div class="meta">
